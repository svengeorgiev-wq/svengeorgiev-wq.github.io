  ...
  function renderToday() {
    ...
    main.innerHTML = `<div class="view">
      <section class="hero-card">
        ...
        <div class="hero-card__art"><a href="https://www.amazon.de/dp/B0GX7G8Z1B/" target="_blank" rel="noopener noreferrer" aria-label="View ADHD & Overthinking for Adults on Amazon (opens in a new tab)"><img src="../assets/cover.webp" alt="Book cover: ADHD & Overthinking for Adults"></a></div>
      </section>
