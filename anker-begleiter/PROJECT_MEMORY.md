...
- Current public refined glass release: resource query `v=9`, service-worker cache `anker-begleiter-v2.1.0`. The system uses layered translucent plum glass, edge highlights, backdrop saturation, gold refractions, and opaque fallbacks. The user explicitly authorized deployment with `los` on 2026-09-06.
