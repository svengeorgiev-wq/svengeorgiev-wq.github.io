...
- Book landing page and cover link: `https://munichpublishing.de/Grenzen_setzen`
- Current visual system: warm peach background, black typography, vivid orange accent, based on the 23.8 final cover.
- Current PWA cache: `grenzen-setzen-v5` in `sw.js`; bump the cache name and visible asset query versions for every shell-affecting release.
